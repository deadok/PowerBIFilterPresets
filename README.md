...
- Сохранение выбранных значений фильтров, проверка найденных фильтров и выбор, какие из них включить в пресет.
- Применение сохранённых пресетов и просмотр результата для каждого фильтра, включая отсутствующие фильтры или значения.
